...
import (
	...
	"github.com/kok-stack/native-kubelet/cmd/virtual-kubelet/internal/commands/providers"
	"github.com/kok-stack/native-kubelet/cmd/virtual-kubelet/internal/commands/root"
	"github.com/kok-stack/native-kubelet/cmd/virtual-kubelet/internal/commands/version"
	"github.com/kok-stack/native-kubelet/cmd/virtual-kubelet/internal/provider"
	"github.com/kok-stack/native-kubelet/log"
	logruslogger "github.com/kok-stack/native-kubelet/log/logrus"
...
func main() {
	...
	opts.Version = strings.Join([]string{k8sVersion, "native-kubelet", "vk", buildVersion}, "-")
